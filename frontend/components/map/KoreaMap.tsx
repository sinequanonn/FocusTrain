...
export function KoreaMap({
  ...
  return (
    <div className="relative flex items-center justify-center rounded-3xl bg-[#EBFBFA] p-5 shadow-sm">
      ...
      {!active && (!departure || !arrival) && (
        <div className="absolute top-6 rounded-full border border-[#2AC1BC]/20 bg-white/90 px-5 py-2 text-sm font-bold text-gray-700 shadow-sm">
