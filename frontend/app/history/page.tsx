    ...
    <main className="mx-auto max-w-4xl p-6 md:p-10">
      <header className="mb-6 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
            ...
            <span className="text-gray-800">기록</span>
          </h1>
      ...
      <section className="rounded-3xl border border-gray-100 bg-white p-2 shadow-sm">
        {!data ? (
          ...
          <p className="p-10 text-center text-sm italic text-gray-400">
            기록이 없습니다.
          </p>
        ) : (
      ...
      {data && data.totalPages > 1 && (
        <div className="mt-6 flex items-center justify-center gap-2">
          <button
            ...
            disabled={page === 0}
            className="rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-bold disabled:opacity-30"
          >
            이전
          </button>
    ...
    <li>
      ...
      >
        ...
        <div className="text-right">
          ...
          <p className="text-[10px] text-gray-400">자세히 →</p>
        </div>
      </Link>
    </li>
  );
